//
//  Part_Activity_Ticket_View.swift
//  Fiesta
//
...
struct Part_Activity_Ticket_View: View {
...
struct Part_Activity_Ticket_View_Previews: PreviewProvider {
    static var previews: some View {
        Part_Activity_Ticket_View(Act_Item: Activity_API().InfoList[0])
    }
}
